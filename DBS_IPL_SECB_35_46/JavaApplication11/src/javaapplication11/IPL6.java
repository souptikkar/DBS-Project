 ...
 * @author MAHE
 */
public class IPL6 extends javax.swing.JFrame {

    /**
     * Creates new form IPL6
     */
    JPanel panel;
static JTable table;
JFrame frame, frame1;
...
String sql = "select players.player_id,name,age,matches,runs,wickets,overseas,soldprice,role,country from players,sold "+"where players.player_id=sold.player_id and sold.team_id='MI'";
...
frame1.setSize(400,300);
    ...
    public static void main(String args[]) throws SQLException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IPL6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
