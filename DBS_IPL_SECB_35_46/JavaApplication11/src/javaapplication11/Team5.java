...
String sql = "select players.player_id,name,age,matches,runs,wickets,overseas,soldprice,role,country from players,sold "+"where players.player_id=sold.player_id and sold.team_id='RPS'";
